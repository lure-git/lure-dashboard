...
$expiring_soon = 0;
foreach ($lure_certificates as $c) {
    if ($c['is_active'] && strtotime($c['expires_at']) < strtotime('+30 days')) {
        $expiring_soon++;
    }
}

// Flash API key (shown once after creation)
...
<head>
    ...
    <title>LURE | API &amp; Certificates</title>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><i class="fas fa-shield-alt text-warning"></i> API &amp; Certificates</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                    ...
                    <form method="post">
                        ...
                        <div class="card-body">
                            <p class="text-muted small mb-3">
                                ...
                                API keys authenticate blocklist EDL feed consumers on port 8443. Use for firewalls, SIEMs, and scripts that consume the blocklist.
                            </p>
                            <div class="row">
                                <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <p class="text-muted small mb-3">
                            <i class="fas fa-info-circle mr-1"></i>
                            Lure certificates are automatically generated during Cast deployment. They allow lures to report health status via mTLS on port 443.
                        </p>
